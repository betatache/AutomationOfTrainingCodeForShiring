...
public class ExpediaResults extends BasePageObject{
	private By price = By.xpath(".//div[@data-test-id='price-column']//span[2]"); // 12242022
	private By journeyDuration = By.xpath(".//div[@data-test-id='journey-duration']"); // 12242022
	private By airline = By.xpath(".//div[@data-test-id='flight-operated']"); // 12242022
	private By layoverInfo = By.xpath(".//div[@data-test-id='layovers']"); // 12242022
	private By progressBar = By.xpath(".//div[@class='uitk-loading-bar-current']"); // 12242022
	private By oneStopCheckbox = By.xpath(".//input[@id='stops-1']"); // 12242022
	private By nonStopCheckbox = By.xpath(".//input[@id='stops-0']"); // 12242022
	...
	/** return false if one stop is not available */
